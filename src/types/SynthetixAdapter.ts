...
export interface SynthetixAdapterInterface extends utils.Interface {
  functions: {
    ...
    'getOriginator()': FunctionFragment;
    'getSynthetix()': FunctionFragment;
    'getSynthetixPriceFeed()': FunctionFragment;
    'getTrackingCode()': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'getOriginator',
    values?: undefined,
  ): string;
  encodeFunctionData(
    functionFragment: 'getSynthetix',
    values?: undefined,
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: 'getTrackingCode',
    values?: undefined,
  ): string;
  encodeFunctionData(
...
export interface SynthetixAdapter extends BaseContract {
  ...
  functions: {
    ...
    /**
     * Gets the `ORIGINATOR` variable
     */
    getOriginator(
      overrides?: CallOverrides,
    ): Promise<[string] & { originator_: string }>;

    /**
     * Gets the `SYNTHETIX` variable
     */
    getSynthetix(
      overrides?: CallOverrides,
    ): Promise<[string] & { synthetix_: string }>;
    ...
    /**
     * Gets the `TRACKING_CODE` variable
     */
    getTrackingCode(
      overrides?: CallOverrides,
    ): Promise<[string] & { trackingCode_: string }>;
   ...
   * Gets the `ORIGINATOR` variable
   */
  getOriginator(overrides?: CallOverrides): Promise<string>;

  /**
   * Gets the `SYNTHETIX` variable
   */
  getSynthetix(overrides?: CallOverrides): Promise<string>;
   ...
   * Gets the `TRACKING_CODE` variable
   */
  getTrackingCode(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
     ...
     * Gets the `ORIGINATOR` variable
     */
    getOriginator(overrides?: CallOverrides): Promise<BigNumber>;

    /**
     * Gets the `SYNTHETIX` variable
     */
    getSynthetix(overrides?: CallOverrides): Promise<BigNumber>;
     ...
     * Gets the `TRACKING_CODE` variable
     */
    getTrackingCode(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
     ...
     * Gets the `ORIGINATOR` variable
     */
    getOriginator(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    /**
     * Gets the `SYNTHETIX` variable
     */
    getSynthetix(overrides?: CallOverrides): Promise<PopulatedTransaction>;
     ...
     * Gets the `TRACKING_CODE` variable
     */
    getTrackingCode(overrides?: CallOverrides): Promise<PopulatedTransaction>;
