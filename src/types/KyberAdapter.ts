...
export interface KyberAdapterInterface extends utils.Interface {
  functions: {
...
export interface KyberAdapter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KyberAdapterInterface;
