...
export interface ParaSwapV4AdapterInterface extends utils.Interface {
  functions: {
    ...
    'getParaSwapV4AugustusSwapper()': FunctionFragment;
    'getParaSwapV4TokenTransferProxy()': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'getParaSwapV4AugustusSwapper',
    values?: undefined,
  ): string;
  encodeFunctionData(
    functionFragment: 'getParaSwapV4TokenTransferProxy',
    values?: undefined,
  ): string;
  encodeFunctionData(
...
export interface ParaSwapV4Adapter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ParaSwapV4AdapterInterface;
  ...
  functions: {
    ...
    /**
     * Gets the `PARA_SWAP_V4_AUGUSTUS_SWAPPER` variable
     */
    getParaSwapV4AugustusSwapper(
      overrides?: CallOverrides,
    ): Promise<[string] & { augustusSwapper_: string }>;

    /**
     * Gets the `PARA_SWAP_V4_TOKEN_TRANSFER_PROXY` variable
     */
    getParaSwapV4TokenTransferProxy(
      overrides?: CallOverrides,
    ): Promise<[string] & { tokenTransferProxy_: string }>;
    ...
    /**
     * ParaSwap v4 completely uses entire outgoing asset balance and incoming asset is sent directly to the beneficiary (the _vaultProxy)
     * Trades assets on ParaSwap
   ...
   * Gets the `PARA_SWAP_V4_AUGUSTUS_SWAPPER` variable
   */
  getParaSwapV4AugustusSwapper(overrides?: CallOverrides): Promise<string>;

  /**
   * Gets the `PARA_SWAP_V4_TOKEN_TRANSFER_PROXY` variable
   */
  getParaSwapV4TokenTransferProxy(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
     ...
     * Gets the `PARA_SWAP_V4_AUGUSTUS_SWAPPER` variable
     */
    getParaSwapV4AugustusSwapper(overrides?: CallOverrides): Promise<BigNumber>;
