...
export interface BuySharesCallerWhitelistInterface extends utils.Interface {
  functions: {
...
export interface BuySharesCallerWhitelist extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BuySharesCallerWhitelistInterface;
  ...
  functions: {
    ...
    passesRule(
      _comptrollerProxy: PromiseOrValue<string>,
      _buySharesCaller: PromiseOrValue<string>,
      overrides?: CallOverrides,
