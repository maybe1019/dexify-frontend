...
export interface AavePriceFeedInterface extends utils.Interface {
  functions: {
    ...
    'getProtocolDataProvider()': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'getProtocolDataProvider',
    values?: undefined,
  ): string;
  encodeFunctionData(
...
export interface AavePriceFeed extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AavePriceFeedInterface;
  ...
  functions: {
    ...
    /**
     * Gets the `PROTOCOL_DATA_PROVIDER` variable value
     */
    getProtocolDataProvider(
      overrides?: CallOverrides,
    ): Promise<[string] & { protocolDataProvider_: string }>;
   ...
   * Gets the `PROTOCOL_DATA_PROVIDER` variable value
   */
  getProtocolDataProvider(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
     ...
     * Gets the `PROTOCOL_DATA_PROVIDER` variable value
     */
    getProtocolDataProvider(overrides?: CallOverrides): Promise<BigNumber>;
