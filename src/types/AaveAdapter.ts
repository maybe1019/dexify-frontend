...
export interface AaveAdapterInterface extends utils.Interface {
  functions: {
    ...
    'getAavePriceFeed()': FunctionFragment;
    'getIntegrationManager()': FunctionFragment;
    'getLendingPoolAddressProvider()': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'getAavePriceFeed',
    values?: undefined,
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: 'getLendingPoolAddressProvider',
    values?: undefined,
  ): string;
  encodeFunctionData(
...
export interface AaveAdapter extends BaseContract {
  ...
  functions: {
    ...
    /**
     * Gets the `AAVE_PRICE_FEED` variable
     */
    getAavePriceFeed(
      overrides?: CallOverrides,
    ): Promise<[string] & { aavePriceFeed_: string }>;
    ...
    /**
     * Gets the `LENDING_POOL_ADDRESS_PROVIDER` variable
     */
    getLendingPoolAddressProvider(
      overrides?: CallOverrides,
    ): Promise<[string] & { lendingPoolAddressProvider_: string }>;

    /**
     * Gets the `REFERRAL_CODE` variable
     */
    getReferralCode(
      overrides?: CallOverrides,
    ): Promise<[number] & { referralCode_: number }>;
    ...
    /**
     * Lends an amount of a token to AAVE
    ...
    /**
     * Redeems an amount of aTokens from AAVE
     * @param _encodedAssetTransferArgs Encoded args for expected assets to spend and receive
     * @param _vaultProxy The VaultProxy of the calling fund
     */
    redeem(
   ...
   * Gets the `AAVE_PRICE_FEED` variable
   */
  getAavePriceFeed(overrides?: CallOverrides): Promise<string>;
   ...
   * Gets the `LENDING_POOL_ADDRESS_PROVIDER` variable
   */
  getLendingPoolAddressProvider(overrides?: CallOverrides): Promise<string>;

  /**
   * Gets the `REFERRAL_CODE` variable
   */
  getReferralCode(overrides?: CallOverrides): Promise<number>;
  ...
  estimateGas: {
     ...
     * Gets the `AAVE_PRICE_FEED` variable
     */
    getAavePriceFeed(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
     ...
     * Gets the `AAVE_PRICE_FEED` variable
     */
    getAavePriceFeed(overrides?: CallOverrides): Promise<PopulatedTransaction>;
