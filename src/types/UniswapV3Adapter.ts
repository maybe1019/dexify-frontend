...
export interface UniswapV3AdapterInterface extends utils.Interface {
  functions: {
    ...
    'getUniswapV3Router()': FunctionFragment;
...
export interface UniswapV3Adapter extends BaseContract {
  ...
  functions: {
    ...
    /**
     * Gets the `UNISWAP_V3_ROUTER` variable
     */
    getUniswapV3Router(
      overrides?: CallOverrides,
   ...
   * Gets the `UNISWAP_V3_ROUTER` variable
   */
  getUniswapV3Router(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
     ...
     * Gets the `UNISWAP_V3_ROUTER` variable
     */
    getUniswapV3Router(overrides?: CallOverrides): Promise<BigNumber>;
