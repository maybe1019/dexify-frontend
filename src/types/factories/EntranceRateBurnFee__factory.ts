...
import type {
  EntranceRateBurnFee,
  EntranceRateBurnFeeInterface,
} from '../EntranceRateBurnFee';
...
type EntranceRateBurnFeeConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: EntranceRateBurnFeeConstructorParams,
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class EntranceRateBurnFee__factory extends ContractFactory {
  constructor(...args: EntranceRateBurnFeeConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<EntranceRateBurnFee> {
    return super.deploy(
      _feeManager,
      overrides || {},
    ) as Promise<EntranceRateBurnFee>;
  }
  ...
  override attach(address: string): EntranceRateBurnFee {
    return super.attach(address) as EntranceRateBurnFee;
  }
  override connect(signer: Signer): EntranceRateBurnFee__factory {
    return super.connect(signer) as EntranceRateBurnFee__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): EntranceRateBurnFeeInterface {
    return new utils.Interface(_abi) as EntranceRateBurnFeeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider,
  ): EntranceRateBurnFee {
    return new Contract(address, _abi, signerOrProvider) as EntranceRateBurnFee;
  }
}
