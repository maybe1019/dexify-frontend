...
export interface YearnVaultV2AdapterInterface extends utils.Interface {
  functions: {
    ...
    'getYearnVaultV2PriceFeed()': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'getYearnVaultV2PriceFeed',
    values?: undefined,
  ): string;
  encodeFunctionData(
...
export interface YearnVaultV2Adapter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: YearnVaultV2AdapterInterface;
  ...
  functions: {
    ...
    /**
     * Gets the `YEARN_VAULT_V2_PRICE_FEED` variable
     */
    getYearnVaultV2PriceFeed(
      overrides?: CallOverrides,
    ): Promise<[string] & { yearnVaultV2PriceFeed_: string }>;
    ...
    /**
     * Using postActionSpendAssetsTransferHandler is probably overkill, but since new yVault v2 contracts can update logic, this protects against a future implementation in which a partial underlying deposit amount is used if the desired amount exceeds the deposit limit, for example.
     * Deposits an amount of an underlying asset into its corresponding yVault
    ...
    /**
     * The amount of yVault shares to be redeemed can be adjusted in yVault.withdraw() depending on the available underlying balance, so we must send unredeemed yVault shares back to the _vaultProxy
     * Redeems an amount of yVault shares for its underlying asset
     * @param _encodedAssetTransferArgs Encoded args for expected assets to spend and receive
     * @param _encodedCallArgs The encoded parameters for the callOnIntegration
     * @param _vaultProxy The VaultProxy of the calling fund
     */
   ...
   * Gets the `YEARN_VAULT_V2_PRICE_FEED` variable
   */
  getYearnVaultV2PriceFeed(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
     ...
     * Gets the `YEARN_VAULT_V2_PRICE_FEED` variable
     */
    getYearnVaultV2PriceFeed(overrides?: CallOverrides): Promise<BigNumber>;
