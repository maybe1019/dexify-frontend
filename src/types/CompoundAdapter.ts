...
export interface CompoundAdapterInterface extends utils.Interface {
  functions: {
    ...
    'getCompoundPriceFeed()': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'getCompoundPriceFeed',
    values?: undefined,
  ): string;
  encodeFunctionData(
...
export interface CompoundAdapter extends BaseContract {
  ...
  functions: {
    ...
    /**
     * Gets the `COMPOUND_PRICE_FEED` variable
     */
    getCompoundPriceFeed(
      overrides?: CallOverrides,
    ): Promise<[string] & { compoundPriceFeed_: string }>;
    ...
    /**
     * Lends an amount of a token to Compound
    ...
    /**
     * Redeems an amount of cTokens from Compound
     * @param _encodedAssetTransferArgs Encoded args for expected assets to spend and receive
     * @param _vaultProxy The VaultProxy of the calling fund
     */
    redeem(
   ...
   * Gets the `COMPOUND_PRICE_FEED` variable
   */
  getCompoundPriceFeed(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
     ...
     * Gets the `COMPOUND_PRICE_FEED` variable
     */
    getCompoundPriceFeed(overrides?: CallOverrides): Promise<BigNumber>;
